...
@Component({
  selector: 'app-layout',
  standalone: true,
  imports: [ RouterOutlet,RouterLink,SearchPopupComponent, HeaderComponent, CustomerReviewsComponent, LatestPostsComponent, InstagramComponent, FooterComponent, FooterBottomComponent],
